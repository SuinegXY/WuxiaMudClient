...
public:
    ...
    static void DrawRect(HDC hDC, const RECT& rc, int nSize, DWORD dwPenColor, bool bDot = false);
    static void DrawRoundRect(HDC hDC, const RECT& rc, int width, int height, int nSize, DWORD dwPenColor, bool bDot = false);
    static void DrawText(HDC hDC, CPaintManagerUI* pManager, RECT& rc, LPCTSTR pstrText, \
        DWORD dwTextColor, int iFont, UINT uStyle, bool bUseGDIP = false);
